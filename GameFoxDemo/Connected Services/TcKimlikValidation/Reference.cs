...
namespace TcKimlikValidation
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://tckimlik.nvi.gov.tr/WS", ConfigurationName="TcKimlikValidation.KPSPublicSoap")]
    public interface KPSPublicSoap: IDisposable
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tckimlik.nvi.gov.tr/WS/TCKimlikNoDogrula", ReplyAction="*")]
        TcKimlikValidation.TCKimlikNoDogrulaResponse TCKimlikNoDogrula(TcKimlikValidation.TCKimlikNoDogrulaRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tckimlik.nvi.gov.tr/WS/TCKimlikNoDogrula", ReplyAction="*")]
        System.Threading.Tasks.Task<TcKimlikValidation.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(TcKimlikValidation.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest
    {
        ...
        public TcKimlikValidation.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest()
        {
        }
        
        public TCKimlikNoDogrulaRequest(TcKimlikValidation.TCKimlikNoDogrulaRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse
    {
        ...
        public TcKimlikValidation.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse()
        {
        }
        
        public TCKimlikNoDogrulaResponse(TcKimlikValidation.TCKimlikNoDogrulaResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface KPSPublicSoapChannel : TcKimlikValidation.KPSPublicSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<TcKimlikValidation.KPSPublicSoap>, TcKimlikValidation.KPSPublicSoap
    {
        ...
        public TcKimlikValidation.TCKimlikNoDogrulaResponse TCKimlikNoDogrula(TcKimlikValidation.TCKimlikNoDogrulaRequest request)
        {
            return base.Channel.TCKimlikNoDogrula(request);
        }
        
        public System.Threading.Tasks.Task<TcKimlikValidation.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(TcKimlikValidation.TCKimlikNoDogrulaRequest request)
        {
